...
class RBM(object):
    ...
    def __init__(self, visibleDimensions, epochs=20, hiddenDimensions=50, ratingValues=10, learningRate=0.001, batchSize=100):
        ...
        self.visibleDimensions = visibleDimensions # count of movies x count of distinct ratings
        self.epochs = epochs
        self.hiddenDimensions = hiddenDimensions
        self.ratingValues = ratingValues           # data has half star rating values, therefore, 10 categories
        self.learningRate = learningRate
        self.batchSize = batchSize                 # minibatch gradient descent
